    ...
    <div className="h-[422px] w-[378.56px] cursor-pointer hover:shadow-md hover:rounded-lg">
      ...
      <div className="flex justify-between mt-4">
        <div className="grid grid-cols-3 border w-[156px] rounded-full px-2 py-1">
          <div className="flex items-center">
            <p className="ml-1 text-[12.95px] font-medium">4 Guests</p>
          </div>
          <div className="flex items-center">
            <p className="ml-1 text-[12.95px] font-medium">2 Rooms</p>
          </div>
          <div className="flex items-center">
            <p className="ml-1 text-[12.95px] font-medium">2-4 Beds</p>
          </div>
        </div>
